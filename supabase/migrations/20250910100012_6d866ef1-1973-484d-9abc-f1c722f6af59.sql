...
('John', 'Smith', '+1 (555) 123-4567', 'john.smith@email.com', DATE '1979-03-15', 'male', 'o+', '123 Main St, City, State', 'Hypertension, Diabetes'),
('Sarah', 'Johnson', '+1 (555) 234-5678', 'sarah.johnson@email.com', DATE '1992-07-22', 'female', 'a+', '456 Oak Ave, City, State', 'Allergic to penicillin'),
('Michael', 'Brown', '+1 (555) 345-6789', 'michael.brown@email.com', DATE '1966-12-10', 'male', 'b+', '789 Pine Rd, City, State', 'Asthma, High cholesterol'),
('Emily', 'Davis', '+1 (555) 456-7890', 'emily.davis@email.com', DATE '1996-05-18', 'female', 'ab+', '321 Elm St, City, State', 'No known allergies'),
('Robert', 'Wilson', '+1 (555) 567-8901', 'robert.wilson@email.com', DATE '1959-09-03', 'male', 'o-', '654 Maple Dr, City, State', 'Heart disease, Arthritis'),
('Lisa', 'Garcia', '+1 (555) 678-9012', 'lisa.garcia@email.com', DATE '1985-11-28', 'female', 'a-', '987 Cedar Ln, City, State', 'Migraine, Anxiety'),
('David', 'Martinez', '+1 (555) 789-0123', 'david.martinez@email.com', DATE '1973-04-14', 'male', 'b-', '147 Birch Way, City, State', 'Diabetes Type 2'),
('Jennifer', 'Rodriguez', '+1 (555) 890-1234', 'jennifer.rodriguez@email.com', DATE '1988-08-07', 'female', 'ab-', '258 Spruce Ct, City, State', 'Thyroid disorder');

-- Add sample appointments for today's patient queue
